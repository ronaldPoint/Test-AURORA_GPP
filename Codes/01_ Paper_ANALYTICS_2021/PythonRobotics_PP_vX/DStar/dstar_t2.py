...
def main():
        ...
        c = 5
    # for c in range (0,len(clearance)):
        ...
        # map, mapX, mapXA, mapXB = map_type.line_coord_gen_5_4(c, map_size, 'Type_5_4')
        ...
        map, mapX, mapXA, mapXB = map_type.line_coord_gen_7_1(clearance[c], map_size, map)
        ...
        manageData.saveData(algorithm, map, sx, sy, gx, gy, rx, ry, len_p, iter, setup, clearance[c])
