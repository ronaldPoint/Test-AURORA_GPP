...
#from AerialNavigation.drone_3d_trajectory_following.DroneSetup import DroneSetup
from math import cos, sin
import numpy as np
from Quadrotor import Quadrotor
from TrajectoryGenerator import TrajectoryGenerator
from mpl_toolkits.mplot3d import Axes3D
from DroneSetup import DroneSetup

show_animation = True

g, m, Ixx, Iyy, Izz, T, Kp_x, Kp_y, Kp_z, Kp_roll, Kp_pitch, Kp_yaw, Kd_x, Kd_y, Kd_z = DroneSetup.get_drone_parameters()
...
def main():
    ...
    y_coeffs = [[], [], [], [], []]
    z_coeffs = [[], [], [], [], []]
    waypoints = [[0, 0, 0], [5, -5, 5], [5, 5, 5], [-5, 5, 5], [0, 0, 0]]
    print(len(waypoints), 'waypoints in this path')
    for i in range(5):
