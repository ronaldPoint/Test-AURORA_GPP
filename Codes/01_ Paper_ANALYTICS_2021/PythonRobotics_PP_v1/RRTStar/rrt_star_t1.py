...
class RRTStar(RRT):
    ...
    def __init__(self,
                 ...
                 obstacle_list,
                 rand_area,
                 expand_dis=10, #  expand_dis=30.0,
                 path_resolution=0.5, #path_resolution=1.0,
                 goal_sample_rate=5, #goal_sample_rate=20.0,
                 max_iter=50000,
...
#    obstacleList, map = Maps.get_map_P1A()  # [x, y, radius]
    ...
    # sx, sy, gx, gy, grid_size, robot_radius = Maps.init_P4()
        ...
        rrt_star = RRTStar(
            ...
            expand_dis=10)  # Este es el que sirve
        
        path, iter = rrt_star.planning(animation=show_animation)

        len = Metrics.get_path_length(path)
